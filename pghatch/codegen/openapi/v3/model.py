...
#   timestamp: 2025-09-14T13:46:24+00:00
...
class Reference(BaseModel):
    __root__: Dict[constr(pattern=r'^\$ref$'), str]
...
class SchemaXORContent(BaseModel):
    __root__: Union[Any, SchemaXORContent1] = Field(
        ...,
...
class Callback(BaseModel):
    __root__: Dict[constr(pattern=r'^x-'), Any]
...
class Model(BaseModel):
    ...
    openapi: constr(pattern=r'^3\.0\.\d(-.+)?$')
    info: Info
    externalDocs: Optional[ExternalDocumentation] = None
...
class Paths(BaseModel):
    ...
    __root__: Union[
        Dict[constr(pattern=r'^\/'), PathItem], Dict[constr(pattern=r'^x-'), Any]
    ]
