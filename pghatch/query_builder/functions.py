...
class PostgreSQLFunctions:
    ...
    def substring(
        self, string: Union[Expression, str], start: int, length: Optional[int] = None
    ) -> FunctionExpression:
        """SUBSTRING function."""
    ...
    def trim(
        self, string: Union[Expression, str], chars: Optional[str] = None
    ) -> FunctionExpression:
        """TRIM function."""
    ...
    def replace(
        self, string: Union[Expression, str], from_str: str, to_str: str
    ) -> FunctionExpression:
        """REPLACE function."""
        args = [
    ...
    def split_part(
        self, string: Union[Expression, str], delimiter: str, field: int
    ) -> FunctionExpression:
        """SPLIT_PART function."""
        args = [
            col(string) if isinstance(string, str) else string,
    ...
    def round(
        self, value: Union[Expression, str], precision: Optional[int] = None
    ) -> FunctionExpression:
        """ROUND function."""
        args = [col(value) if isinstance(value, str) else value]
    ...
    def power(
        self, base: Union[Expression, str], exponent: Union[Expression, str, int]
    ) -> FunctionExpression:
        """POWER function."""
        args = [
    ...
    def date_part(
        self, field: str, source: Union[Expression, str]
    ) -> FunctionExpression:
        """DATE_PART function."""
        args = [literal(field), col(source) if isinstance(source, str) else source]
    ...
    def to_timestamp(
        self, text: Union[Expression, str], format: str
    ) -> FunctionExpression:
    ...
    def json_extract_path(
        self, json_col: Union[Expression, str], *path: str
    ) -> FunctionExpression:
    ...
    def jsonb_extract_path(
        self, jsonb_col: Union[Expression, str], *path: str
    ) -> FunctionExpression:
    ...
    def jsonb_array_length(
        self, jsonb_col: Union[Expression, str]
    ) -> FunctionExpression:
    ...
    # Array Functions
    def array_length(
        self, array: Union[Expression, str], dimension: int = 1
    ) -> FunctionExpression:
